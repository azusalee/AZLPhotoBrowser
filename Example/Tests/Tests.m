...
- (void)testPhotoModel
{
    ...
    AZLPhotoBrowserModel *model1 = [[AZLPhotoBrowserModel alloc] init];
    model1.imageData = backImagedata;
    [model1 requestImage:^(UIImage * _Nullable image) {
        
    }];
    
    AZLPhotoBrowserModel *model2 = [[AZLPhotoBrowserModel alloc] init];
    model2.image = [[UIImage alloc] initWithData:backImagedata];
    [model2 requestImage:^(UIImage * _Nullable image) {
